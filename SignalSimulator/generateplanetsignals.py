...
information_path = os.path.join(script_dir, "planetssmall.csv") #saves all the information for the files
...
np.random.seed(100)
fact= np.random.lognormal(mean=1.08, sigma=0.09, size=numsim)
